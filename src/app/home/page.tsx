...
export default function Home() {
  return (
    ...
    <div className="hidden md:flex absolute inset-y-1/2 -translate-y-30 left-6 flex-col items-start w-5/12">
    ...
    <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 flex gap-4 w-10/12 justify-center md:bottom-40 md:left-10 md:translate-x-0 md:w-auto">
